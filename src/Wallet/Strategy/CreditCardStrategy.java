...
public class CreditCardStrategy implements TransactionStrategy{
    private final WalletRepository walletRepository;
    private final TransactionRepository transactionRepository;

    // Constructor injection required
    public CreditCardStrategy(WalletRepository walletRepository, TransactionRepository transactionRepository) {
    ...
    public void processTransaction(String userId, BigDecimal amount) {
        ...
        try {
            ...
            throw new PaymentProcessingException("Credit card payment failed: " + e.getMessage());
        } finally {
    ...
    private void processCreditCardPayment(BigDecimal amount) {
        // Mock external payment gateway call
        if (amount.compareTo(new BigDecimal("10000")) > 0) {
            throw new PaymentProcessingException("Amount exceeds credit card limit");
        }
