...
public class UpiStrategy implements  TransactionStrategy{
    ...
    public UpiStrategy(WalletRepository walletRepository, TransactionRepository transactionRepository) {
    ...
    public void processTransaction(String userId, BigDecimal amount) {
        ...
        try {
            ...
            throw new PaymentProcessingException("UPI payment failed: " + e.getMessage());
        } finally {
    ...
    private void processUPIPayment(BigDecimal amount) {
        // Mock external payment gateway call
        if (amount.compareTo(new BigDecimal("10000")) > 0) {
            throw new PaymentProcessingException("Amount exceeds UPI limit");
        }
